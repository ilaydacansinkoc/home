...
function App() {
  ...
  return (
    <div className='App'>
      ...
      <Section title='About Me' subtitle={dummyText} id='about-me' />
      <Section title='Career' subtitle={dummyText} id='career' />
      <Section title='Education' subtitle={dummyText} id='education' />
      <Section title='Skills' subtitle={dummyText} id='skills' />
      <Section title='Interests' subtitle={dummyText} id='interests' />
      <Section title='Contact' subtitle={dummyText} id='contact' />
    </div>
  );
}
